...
export default function EducationTracing() {
    return (
        <TracingBeamFull className={"mx-auto antialiased ml-16 relative"}>
            <div className={"space-y-20"}>
                <div className={"flex gap-6 mb-10"}>
                    <Image src={"/images/insa.png"} alt={"INSA Hauts-de-France"} width={100} height={100}
                           className={"object-contain"}/>
                    <div className={"flex flex-col"}>
                        <CardTitle className={"text-lg"}>Master of Engineering - INSA<sup>*</sup> Hauts de France</CardTitle>
                ...
                <div className={"flex gap-6 mb-10"}>
                    <Image src={"/images/insa.png"} alt={"INSA Hauts-de-France"} width={100} height={100}
                           className={"object-contain"}/>
                    <div className={"flex flex-col"}>
                        <CardTitle className={"text-lg"}>Intensive courses - INSA<sup>*</sup> Hauts de France</CardTitle>
