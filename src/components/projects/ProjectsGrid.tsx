...
const projects = [
	{
		title: "./insash",
		description:
			"Co-founder of the INSA Hauts-de-France computer science association. " +
	...
	},
	{
		...
		description:
			"Participation in the Capture The Flag contest, a cyber-security competition between INSA schools. " +
	...
	},
	{
		title: "Cod'INSA",
		description:
			"Cod'INSA is an algorithmic contest between INSA schools. " +
	...
	},
	{
		title: "HebergOS",
		description:
			"Co-Developped with a friend, HebergOS is a software that enables automatic deployment of clustered projects using Docker and Symfony. " +
	...
	},
	{
		title: "Ensembll",
		description:
			"A car parks management web application. For users to book their parking places and administrators to manage car parks, bookings, users and stats.",
