...
export default function SkillsList() {
	return (
		<div className={"flex gap-16 flex-col items-center md:flex-row"}>
			<div
				className={
					"flex h-full w-full max-w-[24rem] items-center justify-center overflow-hidden bg-background"
				}
			>
				<IconCloud icons={skills} />
			</div>

			<ul className="grow grid grid-cols-2 gap-10 md:grid-cols-2 sm:grid-cols-3">
				<li>
